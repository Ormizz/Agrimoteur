                ...
                <div class="breadcrumb-main">
                   ...
                   <div class="breadcrumb-action justify-content-center flex-wrap">
                      <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="uil uil-estate"></i>SPAIN40</a></li>
                            <li class="breadcrumb-item active" aria-current="page">add New Personnal</li>
                         </ol>
                      </nav>
                   </div>
                </div>
                   ...
                   <div class="col-xxl-7 col-lg-10">
                      <div class="mx-sm-30 mx-20 ">
                               ...
                               <div class="add-product__body px-sm-40 px-20">
                                  ...
                                  <form>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="dateNaissance" id="name2" placeholder="Date Naissance">
                                     </div>
                                     ...
                                     <div class="form-group mb-25">
                                        <div class="countryOption">
                                           ...
                                           <select wire:model="status" class="js-example-basic-single js-states form-control">
                                                <option @if($status=='Actif') selected @endif value="Actif">Actif</option>
                                                <option @if($status=='Off') selected @endif value="Off">Off</option>
                                           </select>
                                        </div>
                                     </div>
                                        ...
                                        <div class="countryOption">
                                           ...
                                           <select wire:model="idSexe" class="js-example-basic-single js-states form-control">
                                            @foreach ($sexeList as $sexe)
                                                <option @if($idSexe==$sexe->idSexe) selected @endif value="{{$sexe->idSexe}}">{{$sexe->NatureSexe}}</option>
                                            @endforeach
                                           </select>
                                        </div>
                                     </div>
                         ...
                         <div class="button-group add-product-btn d-flex justify-content-sm-end justify-content-center mt-40">
                            ...
                            <a wire:click="update" class="btn btn-primary btn-default btn-squared text-capitalize">Save</a>
