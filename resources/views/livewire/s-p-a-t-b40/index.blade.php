                ...
                <div class="breadcrumb-main add-contact justify-content-sm-between ">
                   <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                      ...
                      <div class="action-btn mt-sm-0 mt-15">
                         <a href="{{route('SPAIN40Create')}}" class="btn px-20 btn-primary ">
                            <i class="las la-plus fs-16"></i>Add New Personnal
                         </a>
                   ...
                   <div class="userDatatable global-shadow border-light-0 w-100">
                      <div class="table-responsive">
                         <table class="table mb-0 table-borderless">
                            ...
                            <tbody>
                               @foreach ($personnalList as $personnal)
                               <tr>
                                  <td>
                                     <div class="d-flex">
                                  ...
                                  <td>
                                     <div class="userDatatable-content">
                                           {{$personnal->SPATB41->NatureSexe}}
                                     </div>
                                  </td>
                                  <td>
                                     <div class="userDatatable-content">
                                           {{$personnal->created_at}}
                                     </div>
                                  </td>
                                  <td>
                                     <div class="userDatatable-content">
                                           {{$personnal->updated_at}}
                                     </div>
                                  </td>
                                  <td>
                                     <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                        ...
                                        <li>
                                           <a href="{{url('/SPAIN40/edit/'.$personnal->idPers)}}" class="edit">
                                              <i class="uil uil-edit"></i>
                                           </a>
                                        </li>
                                        <li>
                                           <a wire:click="destroy({{$personnal}})" class="remove">
