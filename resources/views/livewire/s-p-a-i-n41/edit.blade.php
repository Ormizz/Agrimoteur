          ...
          <div class="col-lg-12">
             <div class="shop-breadcrumb">
                ...
                <div class="breadcrumb-main">
                   <h4 class="text-capitalize breadcrumb-title">Edit Sex</h4>
                   <div class="breadcrumb-action justify-content-center flex-wrap">
                      <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="uil uil-estate"></i>SPAIN41</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Sex</li>
                         </ol>
                      </nav>
                   </div>
                </div>
                               ...
                               <div class="add-product__body px-sm-40 px-20">
                                  ...
                                  <form>
                                     ...
                                     <div class="form-group">
                                        <label for="name1">ID Sex</label>
                                        <input type="text" class="form-control" wire:model="num" id="name1" placeholder="ID">
                                     </div>

                                     <!-- form group 1 -->
                                     <div class="form-group">
                                        <label for="name2">Libellé</label>
                                        <input type="text" class="form-control" wire:model="NatureSexe" id="name2" placeholder="Libellé">
                                     </div>
                               </div>
                               <!-- End: card body -->
                            </div>
