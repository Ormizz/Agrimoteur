                                    ...
                                    <div class="add-product__body px-sm-40 px-20">
                                       ...
                                       <form>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" wire:model="typeid" id="name1" placeholder="ID">
                                          </div>

                                          <!-- form group 1 -->
                                          <div class="form-group">
                                             <label for="name2">Libellé</label>
                                             <input type="text" class="form-control" wire:model="typelib" id="name2" placeholder="Libellé">
                                          </div>
                                    </div>
                                    <!-- End: card body -->
                                 </div>
